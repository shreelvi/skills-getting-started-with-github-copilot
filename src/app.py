...
activities = {
    ...
    "Swimming Club": {
        "description": "Technique drills, lap practice, and local swim meets",
    ...
    "Science Olympiad": {
        "description": "Team preparation for STEM competitions and hands-on experiments",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Society": {
        "description": "Debate practice, public speaking coaching, and tournaments",
